...
RSpec.feature "Demonstrate message CRUD methods", :js do
  ...
  scenario "A message is empty and new message posts can be generated" do
    When "the message is visited" do
      # pending "you generate scaffold message to see how this test runs"
      message_page.load
    end
    ...
    Then "the user is notified the message was created" do
      expect(message_page.message).to eq "Message was successfully created."
    end
    ...
    Then "the user is notified the message was updated" do
      expect(message_page.message).to eq "Message was successfully updated."
    ...
    Then "the user is notified the message was updated" do
      ...
      expect(message_page.message).to eq "Message was successfully destroyed."
    end
