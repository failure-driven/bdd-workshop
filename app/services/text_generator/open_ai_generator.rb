...
module TextGenerator
  class OpenAIGenerator < AITextGenerator
    ...
    def generate_text(input_text)
      ...
      # LAB 03.1
      # ========
      # The "content" field below is used as the "system prompt" it can be
      # modified to be more sutable as the system prompt you want.
      #
      # STEPS:
      #   1. while playing in the browser with a real AI setup as per README.md
      #   2. modify the "content" below and see the impact on the AI Generated
      #      Text
